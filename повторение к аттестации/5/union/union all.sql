-- объеденяет 2 output множества в одно простым присоединение
-- самостоятельно не делает сортировку
-- выводит запрос по первым алиасам
-- для сортировки по полю нужно его явно указать в селекте
-- можно выводить поля с разными типами но из одного семействва
-- указывать одинаковое количество столбцов из таблиц
