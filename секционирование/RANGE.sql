...
insert into range_tab(order_id, sernum, order_date) values (4, '444', date'2008-01-01'); -- попадет в 200802
insert into range_tab(order_id, sernum, order_date) values (5, '555', date'2008-02-20'); -- попадет в p200803
insert into range_tab(order_id, sernum, order_date) values (6, '666', date'2008-01-20'); -- попадет в p200802
insert into range_tab(order_id, sernum, order_date) values (7, '777', date'2008-02-20'); -- попадет в p200803
commit;
